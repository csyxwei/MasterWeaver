...
class MasterWeaver(torch.nn.Module):
    ...
    def __init__(self, id_encoder, adapter_modules):
        super().__init__()
...
def main():
    ...
    masterweaver_model = MasterWeaver(id_encoder, adapter_modules)
    ...
    # optimizer
    params_to_opt = itertools.chain(masterweaver_model.id_encoder.parameters(), masterweaver_model.adapter_modules.parameters())
    ...
    for epoch in range(0, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            logs = {"loss_mle": loss_mle.detach().item(), "loss_bg": loss_bg.detach().item()}
